...
CORS(app, resources={r"/chat": {"origins": ["http://localhost:5000", "http://localhost:3000", "http://localhost:5173", "https://popcornplay-frontend-l241xqp5p-okdahees-projects.vercel.app", "https://popcornplay-frontend.vercel.app"]}})
